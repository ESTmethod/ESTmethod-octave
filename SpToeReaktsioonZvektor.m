...
function SpTWv = SpToeReaktsioonZvektor(NSARV, NEARV, VarrasN, krdn, selem)
...
suunakosin(1, 1) = -dZ / len; # -Cosbeta
suunakosin(1, 2) = dX / len; # Cosalpha
suunakosin(1, 3) = 0.0;
SpTWv = sparse(suunakosin);
endfunction
