...
aF4=Lpunkt1;
##Fx3=0.0;
Fz5=F3;   % Fz2 projection onto z-axis
...
sumM7=-p3*h08*h08/2+q3*(l1+1.0)*((l1+1.0)/2+l2)-F1*0.6*h+F3*(0.6*l2)+F2*0.6*h+X(87)+X(90)+l1*X(89)+(l1+l2)*X(86)
disp('  ')
...
#         axis([-d Lpikk+d  -Lpikk-0.2*d d], "ij")
   ...
   jaotT=2;
   #
   title('spESTframe7DefWFI',"fontsize",12)
   ax=gca();
...
#
#print('-deps','spESTframe7DefWFI.eps');
#print('-dpng','spESTframe7DefWFI.png');
print('-dfig','-landscape','-mono','-solid','spESTframe7DefWFI.fig');
refresh
#
#%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(2)
...
refresh
#
#print('-deps','spESTframe7DefWFI_h6remaatriks.eps');
#print('-dpng','spESTframe7DefWFI_h6remaatriks.png');
print('-dfig','-landscape','spESTframe7DefWFI_sparse_matrix.fig');
%%print('-dfig','-landscape','-mono','-solid','spESTframe7DefWFI_sparse_matrix.fig');
refresh
#
# octave
disp('-----------------------------------')
