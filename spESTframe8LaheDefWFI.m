...
disp(' sumM7=-p3*h*h/2+q3*(l1+1.0)*((l1+1.0)/2+l2)-F1*0.6*h... ')
disp('       +F3*(0.6*l2)+F2*0.5*h+X(87)+X(90)+l1*X(89)+(l1+l2)*X(86) ')
sumM7=-p3*h*h/2+q3*(l1+1.0)*((l1+1.0)/2+l2)-F1*0.6*h+F3*(0.6*l2)+F2*0.5*h+X(87)+X(90)+l1*X(89)+(l1+l2)*X(86)
disp('  ')
...
#         axis([-d Lpikk+d  -Lpikk-0.2*d d], "ij")
   ...
   jaotT=2;
   #
   title('spESTframe8DefWFI',"fontsize",12)
   ax=gca();
...
#
#print('-deps','spESTframe8DefWFI.eps');
#print('-dpng','spESTframe8DefWFI.png');
print('-dfig','-landscape','-mono','-solid','spESTframe8DefWFI.fig');
refresh
#
#%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(2)
...
refresh
#
#print('-deps','spESTframe8DefWFI_h6remaatriks.eps');
#print('-dpng','spESTframe8DefWFI_h6remaatriks.png');
print('-dfig','-landscape','spESTframe8DefWFI_sparse_matrix.fig');
%%print('-dfig','-landscape','-mono','-solid','spESTframe8DefWFI_sparse_matrix.fig');
refresh
#
# octave
disp('-----------------------------------')
