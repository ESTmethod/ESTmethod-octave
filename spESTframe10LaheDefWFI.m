...
disp('  ')
disp(' sumX=p3*h+F1-F2+X(85)+X(88)+X(91)')
sumX=p3*h+F1-F2+X(85)+X(88)+X(91)
disp('  ')
disp(' The sum of the moments acting  about point 1: ')
disp(' sumM1=-p3*h*h/2-q3*(l1+1.0)*((l1+1.0)/2-1.0)-F1*0.6*h... ')
disp('       -F3*(l1+0.4*l2)+F2*0.6*h+X(87)+X(90)-l1*X(89)-(l1+l2+1.0)*X(92) ')
sumM1=-p3*h*h/2-q3*(l1+1.0)*((l1+1.0)/2-1.0)-F1*0.6*h-F3*(l1+0.4*l2)+...
F2*0.6*h+X(87)+X(90)-l1*X(89)-(l1+l2+1.0)*X(92)
disp('  ')
disp('  The sum of the moments acting  about point 5:  ')
disp(' sumM7=-p3*h*h/2+q3*(l1+1.0)*((l1+1.0)/2+l2+1.0)-F1*0.6*h... ')
disp('       +F3*(0.6*l2+1.0)+F2*0.6*h+X(87)+X(90)+(l2+1.0)*X(89)+(l1+l2+1.0)*X(86) ')
sumM7=-p3*h*h/2+q3*(l1+1.0)*((l1+1.0)/2+l2+1.0)-F1*0.6*h+F3*(0.6*l2+1.0)+F2*0.6*h+X(87)+X(90)+(l2+1.0)*X(89)+(l1+l2+1.0)*X(86)
disp('  ')
...
#         axis([-d Lpikk+d  -Lpikk-0.2*d d], "ij")
   ...
   jaotT=2;
   #
   title('spESTframe10DefWFI',"fontsize",12)
   ax=gca();
...
#
#print('-deps','spESTframe10DefWFI.eps');
#print('-dpng','spESTframe10DefWFI.png');
print('-dfig','-landscape','-mono','-solid','spESTframe10DefWFI.fig');
refresh
#
#%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(2)
...
refresh
#
#print('-deps','spESTframe10DefWFI_h6remaatriks.eps');
#print('-dpng','spESTframe10DefWFI_h6remaatriks.png');
print('-dfig','-landscape','spESTframe10DefWFI_sparse_matrix.fig');
%%print('-dfig','-landscape','-mono','-solid','spESTframe10DefWFI_sparse_matrix.fig');
refresh
#
# octave
disp('-----------------------------------')
