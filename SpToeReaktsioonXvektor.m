...
function transform = SpToeReaktsioonXvektor(node_count, element_count, eid, coordinates, element_properties)
...
if nargin != 5
    error('Function SpToeSiirdeXvektor has wrong number of input arguments!')
end
