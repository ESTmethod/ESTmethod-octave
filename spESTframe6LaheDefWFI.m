...
L6=h;
L7=sqrt(deltah^2+1.0^2); # length of the element
#sqrt(h^2+l4^2);
...
disp(' sumM1=-p3*h08*h08/2-q3*(l1+1.0)*((l1+1.0)/2-1.0)-F1*0.5*h... ')
disp('       -F3*(l1+0.4*l2)+F2*0.6*h+X(87)+X(90)-l1*X(89)-(l1+l2)*X(92) ')
sumM1=-p3*h08*h08/2-q3*(l1+1.0)*((l1+1.0)/2-1.0)-F1*h1-F3*(l1+0.4*l2)+...
F2*0.6*h+X(87)+X(90)-l1*X(89)-(l1+l2)*X(92)
disp('  ')
disp('  The sum of the moments acting  about point 5:  ')
disp(' sumM7=-p3*h08*h08/2+q3*(l1+1.0)*((l1+1.0)/2+l2)-F1*0.5*h... ')
disp('       +F3*(0.6*l2)+F2*0.6*h+X(87)+X(90)+l1*X(89)+(l1+l2)*X(86) ')
sumM7=-p3*h08*h08/2+q3*(l1+1.0)*((l1+1.0)/2+l2)-F1*0.5*h+F3*(0.6*l2)+F2*0.6*h+X(87)+X(90)+l1*X(89)+(l1+l2)*X(86)
disp('  ')
...
#         axis([-d Lpikk+d  -Lpikk-0.2*d d], "ij")
   ...
   jaotT=2;
   #
   title('spESTframe6DefWFI',"fontsize",12)
   ax=gca();
...
#
#print('-deps','spESTframe6DefWFI.eps');
#print('-dpng','spESTframe6DefWFI.png');
print('-dfig','-landscape','-mono','-solid','spESTframe6DefWFI.fig');
refresh
#
#%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(2)
...
refresh
#
#print('-deps','spESTframe6DefWFI_h6remaatriks.eps');
#print('-dpng','spESTframe6DefWFI_h6remaatriks.png');
print('-dfig','-landscape','spESTframe6DefWFI_sparse_matrix.fig');
%%print('-dfig','-landscape','-mono','-solid','spESTframe6DefWFI_sparse_matrix.fig');
refresh
#
# octave
disp('-----------------------------------')
